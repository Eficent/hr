...
class TestHrFiscalyear(common.TransactionCase):
    ...
    def test_create_periods_weekly_payment_same_week(self):
        ...
        periods = self.get_periods(fy)
        self.assertEqual(len(periods), 52)
        self.assertEqual(periods[0].date_payment.strftime('%Y-%m-%d'),
                         '2015-01-04')
        self.assertEqual(periods[1].date_payment.strftime('%Y-%m-%d'),
                         '2015-01-11')
        self.assertEqual(periods[2].date_payment.strftime('%Y-%m-%d'),
                         '2015-01-18')
        self.assertEqual(periods[51].date_payment.strftime('%Y-%m-%d'),
                         '2015-12-27')
    ...
    def test_create_periods_monthly_payment_fifth_day(self):
        ...
        self.assertEqual(periods[2].date_payment.strftime('%Y-%m-%d'),
                         '2015-04-05')
        self.assertEqual(periods[11].date_payment.strftime('%Y-%m-%d'),
                         '2016-01-05')
    ...
    def test_create_periods_semi_monthly_payment_last_day(self):
        ...
        self.assertEqual(periods[2].date_payment.strftime('%Y-%m-%d'),
                         '2015-05-04')
        self.assertEqual(periods[22].date_payment.strftime('%Y-%m-%d'),
                         '2016-03-05')
        self.assertEqual(periods[23].date_payment.strftime('%Y-%m-%d'),
                         '2016-03-19')
